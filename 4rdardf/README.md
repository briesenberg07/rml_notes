...
## test mappings and test data
| desc. | test input | test map | test output | comments/notes |
|---|---|---|---|---|
| Triple with prop X, IRI value | [rda_data_001.ttl](rda_data_001.ttl) | [rda2bf_rml_001.ttl](rda2bf_rml_001.ttl) | [bf_data_002.ttl](bf_data_002.ttl) | |
| Triple with prop X, literal value | [rda_data_002.ttl](rda_data_002.ttl) | [rda2bf_rml_002.ttl](rda2bf_rml_002.ttl) | [bf_data_002.ttl](bf_data_002.ttl) | |
| Triple with prop X, IRI value *and* prop X, literal value | [rda_data_003.ttl](rda_data_003.ttl)| [rda2bf_rml_003.ttl](rda2bf_rml_003.ttl) | [bf_data_003.ttl](bf_data_003.ttl) | |
| @JianPLee test 01 | [003c0e.ttl](003c0e.ttl) | [hasPart.ttl](hasPart.ttl) | [bf_data003c0e.ttl](bf_data003c0e.ttl) | see [[2](#notes)] |
| Doing things with a full rdac:Manifestation record | [lost_airline_colors.ttl](lost_airline_colors.ttl) | [rda2bf_rml_004.ttl](rda2bf_rml_004.ttl) | [bf_data_004.ttl](bf_data_004.ttl) | Did a bit more with [the `rml:iterator` value](https://github.com/briesenberg07/libraryNotes/blob/977fa33d379eebf7f316c348f6a6640c4e6ec573/rml/rda2bf_rml_004.ttl#L23) to avoid specifying only one resource to convert |
| One (1) TriplesMap with two (2) predicateObjectMap statements | [lost_airline_colors.ttl](lost_airline_colors.ttl) | [rda2bf_rml_005.ttl](rda2bf_rml_005.ttl) | [bf_data_005.ttl](bf_data_005.ttl) | `ex:PublicationMap` has [two `rr:predicateObjectMap` statements](https://github.com/briesenberg07/libraryNotes/blob/977fa33d379eebf7f316c348f6a6640c4e6ec573/rml/rda2bf_rml_005.ttl#L56-L70) |
...
![failed search for agent properties](no_agent_props_question.jpg)
![failed search for place properties](no_place_props_question.jpg)
